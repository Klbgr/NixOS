  ...
  services.adguardhome = {
    ...
    settings = {
      ...
      users = [
        {
          name = "antoine";
          password = "$2a$10$b9VFtNN6JFCKc7F657VeE.XeHzjgJacSMAL8vaVwFmId7hs4lW5Au";
        }
      ];
      auth_attemps = 5;
      block_auth_min = 15;
      ...
      filtering = {
        ...
        rewrites = [ ];
        safe_fs_patterns = [
          "/var/lib/private/AdGuardHome/work/userfilters/*"
        ];
        ...
        log = {
          enabled = true;
          file = "/var/lib/private/AdGuardHome/data/agh.log";
          max_backups = 0;
          max_size = 100;
          max_age = 3;
          compress = false;
